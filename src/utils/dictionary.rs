...
// The in memory dictionary which is used during SPIMI
// Posting lists are continuously accumulated in the Dictionary until we reach
// its maximum size at which it is written to a temporary index file on disk
